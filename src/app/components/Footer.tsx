      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full gap-4 md:gap-8">
          ...
          <div className="flex flex-row items-center justify-center gap-3 md:gap-4 md:ml-8 mt-4 md:mt-0">
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={`opacity-70 w-5 h-5 sm:w-6 sm:h-6 group-hover:opacity-100 ${isDarkMode ? 'text-gray-200 group-hover:text-gray-400' : 'text-black group-hover:text-neutral-800'}`}> 
