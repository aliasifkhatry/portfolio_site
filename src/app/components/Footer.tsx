        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full gap-4 md:gap-8">
          ...
          <div className="flex flex-row items-center justify-center gap-3 md:gap-4 md:ml-8 mt-4 md:mt-0">
            ...
            <a
              ...
              className="w-12 h-12 flex items-center justify-center transition-all duration-300 shadow-sm bg-white/70 hover:bg-white/80 dark:bg-neutral-400/20 dark:hover:bg-neutral-400/30 text-neutral-800 dark:text-neutral-300 backdrop-blur-[2px] border border-neutral-400/30 rounded-full relative overflow-hidden opacity-90 group"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={`opacity-70 w-5 h-5 sm:w-6 sm:h-6 group-hover:opacity-100 ${isDarkMode ? 'text-neutral-300 group-hover:text-white' : 'text-black group-hover:text-neutral-800'}`}> 
            ...
            <a
              ...
              className="w-12 h-12 flex items-center justify-center transition-all duration-300 shadow-sm bg-white/70 hover:bg-white/80 dark:bg-neutral-400/20 dark:hover:bg-neutral-400/30 text-neutral-800 dark:text-neutral-300 backdrop-blur-[2px] border border-neutral-400/30 rounded-full relative overflow-hidden opacity-90 group"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={`opacity-70 w-5 h-5 sm:w-6 sm:h-6 group-hover:opacity-100 ${isDarkMode ? 'text-pink-400 group-hover:text-pink-600' : 'text-black group-hover:text-neutral-800'}`}> 
